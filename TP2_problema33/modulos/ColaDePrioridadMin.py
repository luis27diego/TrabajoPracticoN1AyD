class ColaPrioridadMin:
    ...
    def eliminarMin(self):
        # Elimina el elemento con la mínima prioridad (valor) y lo devuelve.
        val_raiz = self.listaMonticulo[1]  # Obtiene la raíz (elemento con mínima prioridad).
        ...
        return val_raiz[1]  # Retorna el valor del elemento con mínima prioridad.
    ...
    def subir(self, i):
        # Ajusta el montículo subiendo un nodo específico para mantener la propiedad de min heap.
        while i // 2 > 0:
    ...
    def bajar(self, i):
        # Ajusta el montículo bajando un nodo específico para mantener la propiedad de min heap.
        while (i * 2) <= self.tamanio:
            mc = self.encontrarMinHijo(i)  # Encuentra el hijo con mínima prioridad.
            if self.listaMonticulo[i][0] > self.listaMonticulo[mc][0]:  # Compara con el hijo de mínima prioridad.
    ...
    def encontrarMinHijo(self, i):
        # Encuentra el hijo con mínima prioridad del nodo en la posición 'i'.
        if i * 2 + 1 > self.tamanio:
            ...
            if self.listaMonticulo[i * 2][0] < self.listaMonticulo[i * 2 + 1][0]:  # Compara los hijos.
                return i * 2  # Devuelve el índice del hijo de mínima prioridad.
            else:
                return i * 2 + 1  # Devuelve el índice del otro hijo de mínima prioridad.
